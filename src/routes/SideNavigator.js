...
const SideNavigator = props => {
  ...
  return (
    <Drawer.Navigator
      ...
      <Drawer.Screen
        name={RouteName.ORGAIZER_SCREEN}
        component={OrganizerScreen}
        options={{
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Organizer_Text')} />
          ),
          ...HeaderArray,
      ...
      />
      <Drawer.Screen
        name={RouteName.TRENDING_SCREEN}
        component={TrendingScreen}
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Trending_Text')} />
          ),
      ...
      <Drawer.Screen
        ...
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Search_Text')} />
          ),
        }}
      />
      <Drawer.Screen
      ...
      />
      <Drawer.Screen
        name={RouteName.BUY_TICKET_SCREEN}
        component={BuyTicketScreen}
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Buy_Ticket_Text')} />
          ),
        }}
      />
      <Drawer.Screen
        ...
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Payment_Text')} />
          ),
        }}
      />
      <Drawer.Screen
        ...
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Ticket_Text')} />
          ),
        }}
      />
      <Drawer.Screen
        ...
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Reviews_Text')} />
          ),
        }}
      />
      <Drawer.Screen
      ...
      />
      <Drawer.Screen
        name={RouteName.SCAN_SCREEN}
        component={Scanner}
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Scan_Text')} />
          ),
        }}
      />
      <Drawer.Screen
        name={RouteName.BOOKMARK_TAB}
        component={Bookmarks}
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Bookmark_Text')} />
          ),
        }}
      />
      <Drawer.Screen
        name={RouteName.PAYMENT_SUCCESSFULL}
        component={PaymentSuccessFully}
        options={{
          ...HeaderArray,
          headerTitle: props => (
            <AppHeader {...props} headerTitle={t('Payment_SuccessFul')} />
          ),
        }}
      />
      <Drawer.Screen
