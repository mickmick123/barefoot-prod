    ...
    <View>
      <View style={ColorPickerStyles.centeredViewtwo}>
          ...
          <View style={ColorPickerStyles.centeredView}>
            <View style={ColorPickerStyles.modalView}>
              <View style={ColorPickerStyles.setheight}>
                <View
                  style={[{backgroundColor: currentColor, borderRadius: 7}]}>
                  <Text style={ColorPickerStyles.setcolorwhite}>
                    {currentColor}
                  </Text>
                  <ColorPicker
                    // ref={r => { picker = r }}
        ...
        <TouchableOpacity onPress={() => setModalVisible(true)}>
          <Image
            style={ColorPickerStyles.colorpickerpickerimagwidth}
            resizeMode="cover"
            source={images.Color_picker_image}
          />
        </TouchableOpacity>
      </View>
    </View>
