  ...
  return (
    <ScrollView>
      <View style={Sidemenu.customslidebarmenu}>
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.EVENT_TAB)}>
          <VectorIcon
            icon="MaterialIcons"
            size={SH(19)}
            name="event"
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.ADD_EVENT_SCREEN)}>
          <VectorIcon
            icon="AntDesign"
            size={SH(19)}
            name="addfile"
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.EVENT_AROUND_MAP)}>
          <VectorIcon
            icon="FontAwesome"
            size={SH(19)}
            name="map-marker"
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.BOOKMARK_TAB)}>
          <VectorIcon
            icon="FontAwesome"
            name="bookmark"
            style={Sidemenu.logoimage}
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.TRENDING_SCREEN)}>
          <VectorIcon
            icon="Feather"
            size={SH(19)}
            name="trending-up"
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.SEARCH_SCREEN)}>
          <VectorIcon
            icon="AntDesign"
            size={SH(19)}
            name="search1"
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.EVENTS_DETAILS_SCREEN)}>
          <VectorIcon
            icon="MaterialIcons"
            size={SH(19)}
            name="event"
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.ORGAIZER_SCREEN)}>
          <VectorIcon
            icon="FontAwesome5"
            size={SH(19)}
            name="history"
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.BUY_TICKET_SCREEN)}>
          <VectorIcon
            icon="Entypo"
            size={SH(19)}
            name="ticket"
        ...
        <TouchableOpacity
          style={Sidemenu.flexrowset}
          onPress={() => Onpressfunction(RouteName.SCAN_SCREEN)}>
          <VectorIcon
            icon="MaterialIcons"
            size={SH(19)}
