...
function MapLocation(props) {
  ...
  const {position, onPress, onDragEnd} = props;
  ...
  return (
    <MapView
      ...
      <Marker
        onPress={() => onPress()}
        coordinate={{
          latitude: 22.288422599884058,
          longitude: 70.79374689024529,
        }}>
        <Image
          resizeMethod="resize"
      ...
      <Marker
        onPress={() => onPress()}
        coordinate={{
          latitude: 22.287481876042634,
          longitude: 70.79179173523978,
        }}>
        <Image
          resizeMethod="resize"
      ...
      <Marker
        onPress={() => onPress()}
        coordinate={{
          latitude: 22.28763866378918,
          longitude: 70.79570204525076,
        }}>
        <Image
          resizeMethod="resize"
      ...
      <Marker
        onPress={() => onPress()}
        coordinate={{
          latitude: 17.542751593159494,
          longitude: 78.51921435307105,
        }}>
        <Image
          resizeMethod="resize"
          source={images.Slider_four_image}
      ...
      <Marker
        onPress={() => onPress()}
        coordinate={{
          latitude: 22.287958922828697,
          longitude: 70.79481940772033,
        }}>
        <Image
          resizeMethod="resize"
