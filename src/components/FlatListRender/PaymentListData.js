        ...
        <View style={PaymentStyle.SetFlexRowArrowLeftThree}>
          <View style={PaymentStyle.FlexRowCreditCard}>
            ...
            <View style={PaymentStyle.SetTextWidth}>
              ...
              <Text style={PaymentStyle.YouNeedsText}>
          ...
          <View>
            <TouchableOpacity onPress={() => toggleHandler(item.id)}>
              {show === item.id ? (
                <VectorIcon icon="AntDesign" name="up" size={SF(21)} />
              ) : (
                <VectorIcon icon="AntDesign" name="down" size={SF(21)} />
              )}
            </TouchableOpacity>
          </View>
        </View>
      ...
      {show === item.id ? (
        <View>
          <View style={PaymentStyle.SetParegraphViewStyle}>
            <Text style={PaymentStyle.ParegraphTextStyleset}>
              {t('Super_is_India')}
            </Text>
          </View>
        </View>
