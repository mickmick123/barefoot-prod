...
const FAQData = props => {
  ...
  return (
    <TouchableOpacity
      style={HelpScreenStyle.BgColorWhite}
        ...
        <View style={HelpScreenStyle.FlexRowArrowLeftThree}>
          <View style={HelpScreenStyle.FlexRowCreditCard}>
            <View style={HelpScreenStyle.TextWidth}>
              <Text style={HelpScreenStyle.CreditCardText}>
                {t(item.smalltext)}
              </Text>
            </View>
          </View>
          <View>
            <TouchableOpacity onPress={() => toggleHandler(item.id)}>
              {show === item.id ? (
                <VectorIcon icon="AntDesign" name="up" size={21} />
              ) : (
                <VectorIcon icon="AntDesign" name="down" size={21} />
              )}
            </TouchableOpacity>
          </View>
        </View>
      ...
      {show === item.id ? (
        <View>
          <View style={HelpScreenStyle.ParegraPhViewStyle}>
            <Text style={HelpScreenStyle.ParegraphTextHelp}>
