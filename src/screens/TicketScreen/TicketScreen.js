...
const TicketScreen = props => {
  ...
  return (
    <View
      style={[
        AddEventsStyle.minstyleviewphotograpgy,
        AddEventsStyle.bgcolorset,
      ]}>
      <StatusBar
            ...
            <View style={AddEventsStyle.minflexview}>
              <View style={AddEventsStyle.DownloadTicket}>
                <View style={AddEventsStyle.qrcodescanner}>
                  <View>
                    <Text style={AddEventsStyle.qrcosetitlestyles}>
                      {t('Bastu_Conntected')}
                    </Text>
                    <Image
                      source={images.Scanner_image_one}
                      resizeMode={'contain'}
                      style={AddEventsStyle.imagestyleset}
                    />
                  </View>
                </View>
                <View>
                  <Spacing space={SH(70)} />
                  <Text style={AddEventsStyle.nametextstyles}>
                    {t('Name_Text')}
                  </Text>
                  <Text style={AddEventsStyle.nametextstylestwo}>
                    {t('John_Smith')}
                  </Text>
                  <Spacing space={SH(20)} />
