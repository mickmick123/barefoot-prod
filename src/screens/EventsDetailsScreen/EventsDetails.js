...
const EventsDetails = props => {
  ...
  return (
    <View style={[EventsStyle.minstyleviewphotograpgy, EventsStyle.bgcolorset]}>
      <TouchableOpacity
        style={EventsStyle.Backaerrowwhite}
                ...
                <View style={EventsStyle.Flexview}>
                  ...
                  <View style={EventsStyle.watchingflexviewstyle}>
                    <View style={EventsStyle.Imageviewstyles}>
                      <Image
                        source={detailsStore.joiimage}
                        style={EventsStyle.Imagestylestwo}
                      />
                      <Image
                        source={detailsStore.joiimagetwo}
                        style={EventsStyle.Imagestylesthtree}
                      />
                      <Image
                        source={detailsStore.joiimagethree}
                        style={EventsStyle.Imagestylesthfour}
                      />
                    </View>
                ...
                <View>
                  ...
                  <View style={EventsStyle.Flexrowestyles}>
                    ...
                    <View>
                      ...
                      <Button
                        ...
                        buttonStyle={EventsStyle.Addtomybutton}
                        buttonTextStyle={EventsStyle.Addtextstyles}
                  ...
                  <View>
                    <Button
                      ...
                      buttonTextStyle={EventsStyle.Textstyle}
      ...
      <View style={EventsStyle.Bottomviewsetstyles}>
        <View style={EventsStyle.Flexrowseticon}>
          <TouchableOpacity
            ...
            style={EventsStyle.Calenderstyle}>
            <VectorIcon
              icon="AntDesign"
              name="sharealt"
              size={25}
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate(RouteName.BOOKMARK_TAB)}
            style={EventsStyle.Calenderstyle}>
            <VectorIcon
              icon="Ionicons"
