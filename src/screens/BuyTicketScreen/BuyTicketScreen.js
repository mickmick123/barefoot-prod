    ...
    <View
      ...
      <View>
            ...
            <View style={NotificationStyle.minflexview}>
              <View style={NotificationStyle.minviewsigninscreen}>
                <View style={NotificationStyle.Setwidth}>
                  <Text style={NotificationStyle.Tickettextstyles}>
                    {t('Ticket_Type')}
                  </Text>
                  <Spacing space={SH(10)} />
                  <View style={NotificationStyle.Setbuttonwidth}>
                    <TouchableOpacity
                      onPress={() => Selectedcolor(1)}
                      style={
                        color === 1
                          ? NotificationStyle.vipbuttonstylestwo
                          : NotificationStyle.vipbuttonstyles
                      }>
                      <Text
                        style={
                          color === 1
                            ? NotificationStyle.viptextstylestwo
                            : NotificationStyle.viptextstyles
                        }>
                        {t('Vip_Type')}
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                      onPress={() => Selectedcolor(2)}
                      style={
                        color === 2
                          ? NotificationStyle.vipbuttonstylestwo
                          : NotificationStyle.vipbuttonstyles
                  ...
                  <View style={NotificationStyle.buttonStyleflex}>
                    <TouchableOpacity
                      ...
                      style={NotificationStyle.iconstyles}>
                      <IconF
                        name="minus"
                        size={23}
                    ...
                    <TouchableOpacity>
                      <Text style={NotificationStyle.Counttextstyles}>
                        {count}
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity
        ...
        <View style={NotificationStyle.Setpostionabsolute}>
          <Text style={NotificationStyle.Totaldolardtextstyles}>
            {t('Total_Text')}{' '}
            <Text style={NotificationStyle.Dolardte3xtstyles}>
              $ {counttwo}
            </Text>
          </Text>
          <Spacing space={SH(30)} />
