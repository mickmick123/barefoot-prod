...
const ProfileTab = props => {
  ...
  const ucWords = w => {
    const str = w.toLowerCase().replace(/\b[a-z]/g, function (letter) {
        ...
        <View style={ProfileTabStyle.ImagCenter}>
          <View>
            ...
            <Text style={ProfileTabStyle.UserName}>
              {ucWords(`${userData.first_name} ${userData.first_name}`)}
            </Text>
          </View>
        </View>
                            ...
                            <View style={Style.InputViewWidth}>
                              ...
                              <TouchableOpacity
                                ...
                                <VectorIcon
                                  icon="Ionicons"
                                  name={
                                    passwordVisibilityold ? 'eye-off' : 'eye'
                                  }
                                  size={25}
                                  style={ProfileTabStyle.eyeiconset}
                                />
                              </TouchableOpacity>
                            </View>
                          </View>
                            ...
                            <View style={Style.InputViewWidth}>
                              ...
                              <TouchableOpacity
                                ...
                                <VectorIcon
                                  icon="Ionicons"
                                  name={
                                    passwordVisibilitynew ? 'eye-off' : 'eye'
                                  }
                                  size={25}
                                  style={ProfileTabStyle.eyeiconset}
                                />
