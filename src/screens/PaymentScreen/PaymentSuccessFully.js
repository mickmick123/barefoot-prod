            ...
            <View style={PaymentSuccessFuls.MinViewSigninScreen}>
              <TouchableOpacity style={PaymentSuccessFuls.Imagecebter}>
                <Image
                  ...
                  resizeMode="center"
                  style={PaymentSuccessFuls.PaymentSuccesfullImg}
                />
              </TouchableOpacity>
              <View style={PaymentSuccessFuls.TextCenterView}>
                <Text style={PaymentSuccessFuls.TextCenterPayment}>
                  {t('PAYMENT_SUCCESSFULL')}
                </Text>
              </View>
              <Text style={PaymentSuccessFuls.TextCenterPaymentTwo}>
                {t('Your_payment_has_been')}
              </Text>
              <TouchableOpacity style={PaymentSuccessFuls.FlexRowcoffiText}>
                <Text style={PaymentSuccessFuls.TotalQAmountPaid}>
                  {t('PAYED_BY')}
                </Text>
                <Text style={PaymentSuccessFuls.PriceTextSet}>
                  {t('Google_Pay')}
                </Text>
              </TouchableOpacity>
